...
<head>
	...
	<title><s:property value="getText('lattineDisponibili.title')"/></title>
</head>
<body>
	<h1><s:property value="getText('lattineDisponibili.header')"/></h1>
	<div id="contenitore">
		<div id="menu">
			<menu>
		...
		<div id="content">
			<h1><s:property value="getText('lattineDisponibili.h1')"/></h1>
			<s:form action="lattineDisponibili">
				...
				<s:submit key="lattineDisponibili.submit" ></s:submit>
			</s:form>
			
			<div id="messaggio">
				<s:if test="valido != null">
					<s:if test="valido == true">
						<p><s:property value="getText('lattineDisponibili.message.true')"/></p>
					</s:if>
					<s:else>
						<p><s:property value="getText('lattineDisponibili.message.false')"/></p>
					</s:else>
				</s:if>
			</div>	
		</div>
